...
The main project video is [[https://youtu.be/ppaN8IdK0a0][hosted on YouTube]] as well as included in the repository (advanced_lane_line_finding.mp4). A second debug video is also included which shows the results of the various stages of transformation that lead up to final image simultaneously ([[https://youtu.be/v5uqnKxBYmY][YouTube]] link, was too large for GitHub to accept).
